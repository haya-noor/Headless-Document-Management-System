...
import { UserRepositoryImpl } from '../../infrastructure/repositories/implementations/user.repository';
import { PasswordService } from './password.service';
// JWT utilities removed - no longer needed for domain-focused project
...
export class UserService {
  ...
  /**
   * User logout (simplified without blacklisting)
   */
