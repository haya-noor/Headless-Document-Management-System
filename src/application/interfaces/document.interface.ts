...
import { Repository, RepositoryErrorType, DatabaseError, NotFoundError } from './base.interface';
...
> {
   ...
   */
  softDelete(documentId: string): Effect.Effect<boolean, NotFoundError | DatabaseError>;
